package com.jzleon.seguridadPedidos.Controladores;
import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.http.HttpStatus;
import org.springframework.web.bind.annotation.*;
import com.jzleon.seguridadPedidos.Modelos.Permiso;
import com.jzleon.seguridadPedidos.Modelos.PermisosRoles;
import com.jzleon.seguridadPedidos.Modelos.Rol;
import com.jzleon.seguridadPedidos.Repositorios.RepositorioPermiso;
import com.jzleon.seguridadPedidos.Repositorios.RepositorioPermisosRoles;
import com.jzleon.seguridadPedidos.Repositorios.ReposistorioRol;
...
public class ControladorPermisosRoles {
    ...
    @Autowired
    private ReposistorioRol miRepositorioRol;
    @GetMapping("")
    ...
    public PermisosRoles getPermiso(@PathVariable String id_rol, @RequestBody Permiso infoPermiso){
        ...
        if (elPermiso!=null && elRol!=null){
            return
                    this.miRepositorioPermisoRoles.getPermisoRol(elRol.get_id(),
                            elPermiso.get_id());
        }else{
            return null;
        }
